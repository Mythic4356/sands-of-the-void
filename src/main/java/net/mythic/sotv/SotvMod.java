...
@Mod("sotv")
public class SotvMod {
	public static final Logger LOGGER = LogManager.getLogger(SotvMod.class);
	public static final String MODID = "sotv";

	public SotvMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		SotvModBlocks.REGISTRY.register(modEventBus);
