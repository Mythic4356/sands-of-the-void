...
import net.mythic.sotv.procedures.ScrutimiteOnEntityTickUpdateProcedure;
import net.mythic.sotv.procedures.ScrutimiteEntityDiesProcedure;
...
public class ScrutimiteEntity extends Monster implements GeoEntity {
	...
	public void baseTick() {
		super.baseTick();
		ScrutimiteOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
